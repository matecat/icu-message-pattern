...
enum ArgType
{
     ...
     * When the selector includes an explicit value (e.g., '=2'),
     * the preceding ARG_INT or ARG_DOUBLE provides that value for the message.
    ...
    /**
     * @return bool true if the argument type has a plural style part sequence and semantics,
